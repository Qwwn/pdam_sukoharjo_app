package com.metromultindo.tirtapanrannuangku.data.model
        ...
        imageUrl = this.newsImage?.let { imageUrl ->
            ...
            when {
                imageUrl.startsWith("http://localhost/") ->
                    imageUrl.replace("http://localhost/", "http://pdamtakalar.ddns.net:8081/")
                imageUrl.startsWith("http://127.0.0.1/") ->
                    imageUrl.replace("http://127.0.0.1/", "http://pdamtakalar.ddns.net:8081/")
                else -> imageUrl
            }
        },
